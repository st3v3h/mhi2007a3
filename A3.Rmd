...
library(QuantPsyc) # For Beta values
library(ppcor) #for pr values
...
#subset the data for analysis -- DV = polaff ("independen" factor filtered out); cat IV = work; contin IV = age
lr <- data %>% 
